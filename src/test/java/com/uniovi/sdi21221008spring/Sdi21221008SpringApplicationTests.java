...
class Sdi21221008SpringApplicationTests {

    static String PathFirefox = "C:\\Program Files\\Mozilla Firefox\\firefox.exe";
    //static String Geckodriver = "C:\\Path\\geckodriver-v0.30.0-win64.exe";
    static String Geckodriver = "C:\\Users\\pablo\\OneDrive\\Escritorio\\Informatica\\3º\\SDI\\Laboratorio\\sesion05\\PL-SDI-Sesión5-material\\geckodriver-v0.30.0-win64.exe";
    ...
    public void PR06C() {
        PO_HomeView.clickOption(driver, "signup", "class", "btn btn-primary");
        PO_SignUpView.fillForm(driver, "99999990C", "Josefo", "Pera", "77777", "77777");
    ...
    public void PR06F() {
        ...
        //Comprobamos el error de contraseña no repetida .
    ...
    public void PR12() {
        ...
        Assertions.assertEquals(4, PO_PrivateView.countNumberOfMarks(driver,"//tbody/tr"));
        //Ahora nos desconectamos y comprobamos que aparece el menú de registro
        String loginText = PO_HomeView.getP().getString("signup.message", PO_Properties.getSPANISH());
        PO_PrivateView.clickOption(driver, "logout", "text", loginText);
    }

    //PR13. Loguearse, comprobar detalles y desconectarse usando el rol de estudiante
    @Test
    @Order(19)
    public void PR13() {
        //Comprobamos que entramos en la pagina privada de Alumno
        ...
        // Contamos las notas
        PO_PrivateView.clickMarkDetails(driver,"//td[contains(text(), 'Nota A2')]/following-sibling::*[2]");
    ...
    //PR14. Loguearse, comprobar detalles y desconectarse usando el rol de estudiante
    @Test
    @Order(20)
    public void PR14() {
        ...
        PO_PrivateView.openNavOption(driver, "//li[contains(@id, 'marks-menu')]/a", 0);
        //Esperamos a que aparezca la opción de añadir nota: //a[contains(@href, 'mark/add')]
        //Pinchamos en agregar Nota.
        PO_PrivateView.openNavOption(driver, "//a[contains(@href, 'mark/add')]", 0);
        ...
        PO_PrivateView.openNavOption(driver, "//a[contains(@class, 'page-link')]", 3);
    ...
    public void PR15() {
        ...
        PO_PrivateView.openNavOption(driver, "//a[contains(@href, 'mark/list')]", 0);
        //Esperamos a que se muestren los enlaces de paginación la lista de notas
        //Nos vamos a la última página
        PO_PrivateView.openNavOption(driver, "//a[contains(@class, 'page-link')]", 3);
        // Esperamos a que aparezca la Nueva nota en la última página
        // Y Pinchamos en el enlace de borrado de la Nota "Nota Nueva 1"
        PO_PrivateView.openNavOption(driver,
